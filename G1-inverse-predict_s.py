...
dataPath_G1predict = 'data/data2_500_A_over0-82.csv'
...
if __name__ == '__main__':
    ...
    exportTensor('data/G1-predict/G1-predict_'+modelname1+'_s_data2_500_A_over0-82', ff, s_names + f_target_names + f_F1_names)
