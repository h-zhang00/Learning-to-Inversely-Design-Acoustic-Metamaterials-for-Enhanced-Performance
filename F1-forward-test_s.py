...
dataPath_F1test = './data/data1_1000_S-A_range2.csv'
modelname = 'F1-range2'
...
if __name__ == '__main__':
    ...
    exportTensor('data/F1-test/F1_test_data1_1000_S-A_range2_loss_history', F1_test_history, ['F1-test-loss'])

    ff = torch.cat((f_test_pred, f_test, f_test_pred_mean, f_test_mean, f_mean_diff, F1_test_history), dim=1)

    exportTensor('data/F1-test/F1_test_data1_1000_S-A_range2', ff, f_F1_names + f_FEM_names + ['f_test_pred_mean'] + ['f_test_FEM_mean'] + ['f_mean_diff'] + ['f_Fnloss'])
